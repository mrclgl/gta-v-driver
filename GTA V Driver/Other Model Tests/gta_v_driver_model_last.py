...
def gta_v_driver_model(features, mode):
    ...
    inception_module_1 = inception_module(conv2, 16, 24)
	
    #print(inception_module_1.shape)
	
    inception_module_2 = inception_module(inception_module_1, 24, 32)
	
    #print(inception_module_2.shape)
	
    inception_module_3 = inception_module(inception_module_2, 32, 48)
    ...
    dense1 = tf.layers.dense(inputs=conv6_flat, units=4096, activation=tf.nn.relu)
